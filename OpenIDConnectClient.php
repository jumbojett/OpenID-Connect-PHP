...
if (!class_exists('\phpseclib\Crypt\RSA') && !class_exists('Crypt_RSA')) {
    user_error(
        'Unable to find phpseclib Crypt/RSA.php.  " .
        "Ensure phpseclib is installed and in include_path before you include this file'
    );
}
...
class OpenIDConnectClient
{
    ...
    private function getProviderConfigValue($param, $default = null)
    {
        ...
        if (!isset($this->providerConfig[$param])) {
            ...
            if ($value) {
                ...
                throw new OpenIDConnectClientException(
                    "The provider {$param} has not been set. " .
    ...
    public function register()
    {
        ...
        if (isset($json_response->{'client_secret'})) {
            ...
            throw new OpenIDConnectClientException(
                "Error registering: " .
                "Please contact the OpenID Connect provider and " .
                "obtain a Client ID and Secret directly from them"
            );
        }
    }
